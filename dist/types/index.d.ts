...
export type TransactionStatus = 'pending_external' | 'pending_anchor' | 'pending_stellar' | 'pending_trust' | 'pending_user' | 'pending_user_transfer_start' | 'completed' | 'refunded' | 'expired' | 'error' | 'incomplete' | 'no_market' | 'too_small' | 'too_large';
